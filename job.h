...
#define JOB_SPEC_HEADER_FORMAT  "%9s %3s %9s %9s %10s %9s %s %s %s %s %s\n"
...
#define JOB_SPEC_FORMAT         JOB_SPEC_NUMS_FORMAT " %s %s %s %s %s\n"
#define JOB_FIELD_MAX_LEN       1024
#define JOB_STR_MAX_LEN         2048    // Fixme: MAX_PATH + x?
#define JOB_SPECS_ITEMS         11      // # fields in the struct
