...
OBJS1   = lpjs-dispatch.o config.o node.o node-list.o \
	  node-list-mutators.o node-mutators.o
OBJS2   = lpjs-node-specs.o
OBJS3   = lpjs-nodes.o config.o node-list.o node-list-mutators.o \
	  node.o node-mutators.o network.o
OBJS4   = lpjs-jobs.o config.o node-list.o node-list-mutators.o \
	  node.o node-mutators.o network.o
...
${BIN1}: ${OBJS1}
	${LD} -o ${BIN1} ${OBJS1} ${LDFLAGS}

${BIN2}: ${OBJS2}
	${LD} -o ${BIN2} ${OBJS2} ${LDFLAGS}

${BIN3}: ${OBJS3}
	${LD} -o ${BIN3} ${OBJS3} ${LDFLAGS}

${BIN4}: ${OBJS4}
	${LD} -o ${BIN4} ${OBJS4} ${LDFLAGS}
